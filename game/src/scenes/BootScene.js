...
class BootScene extends Phaser.Scene {
    ...
    generateButtonTextures() {
        ...
        g.fillRect(26, 20, 12, 4);   // top bar
        g.fillRect(22, 24, 8, 4);    // upper curve
        g.fillRect(26, 28, 12, 4);   // bottom bar
        g.fillRect(34, 24, 4, 8);    // right connector
        // Wrench handle (diagonal shaft)
        g.fillStyle(0xFFD700, 0.9);
        g.fillRect(22, 32, 20, 3);
        g.fillRect(30, 35, 16, 3);
        // Handle end
        g.fillStyle(0xFFD700, 0.7);
        g.fillRect(42, 34, 5, 5);
        g.generateTexture('btn-throw', 64, 64);
        g.destroy();
    }
    ...
    generatePixelArtTextures() {
        ...
        // ── Wrench throw (12x8, pixelSize=2) — small wrench projectile ──
        this.drawPixelArt('wrench-throw', [
            ['#222','#222','#222','#222','#222','#222','#222','#222','#222','#222','#222','#222'],
            ['#222','#CC8','#CC8','#CC8','#CC8','#222','#222','#222','#222','#222','#222','#222'],
            ['#222','#CC8','#888','#888','#CC8','#222','#222','#222','#222','#222','#222','#222'],
            ['#222','#CC8','#CC8','#CC8','#CC8','#CC8','#222','#222','#222','#222','#222','#222'],
            ['#222','#222','#222','#222','#222','#222','#CC8','#222','#222','#222','#222','#222'],
            ['#222','#222','#222','#222','#222','#222','#222','#CC8','#222','#222','#222','#222'],
            ['#222','#222','#222','#222','#222','#222','#222','#222','#CC8','#222','#222','#222'],
            ['#222','#222','#222','#222','#222','#222','#222','#222','#222','#222','#222','#222'],
        ], 2);
